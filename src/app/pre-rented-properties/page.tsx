...
import { getPreRentedProperties } from '@/data/mockProperties';

export default function PreRentedPropertiesPage() {
  const [properties, setProperties] = useState<Property[]>([]);
  const [viewedProperty, setViewedProperty] = useState<Property | null>(null);

  useEffect(() => {
    getPreRentedProperties().then(setProperties);
  }, []);

  return (
    <main className="container mx-auto px-4 py-12">
      <h1 className="text-3xl font-bold mb-6 text-center">Pre-Rented Properties</h1>
