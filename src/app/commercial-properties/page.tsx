...
import { getCommercialProperties } from '@/data/mockProperties';
...
export default function CommercialPropertiesPage() {
  ...
  useEffect(() => {
    getCommercialProperties().then(setProperties);
  }, []);

  return (
    <main className="container mx-auto px-4 py-12">
      <h1 className="text-3xl font-bold mb-6 text-center">Commercial Properties</h1>
